...
const STYLES = {
  card: "bg-[#18181b]/80 border border-white/10 rounded-2xl shadow-lg px-6 py-5 flex flex-col gap-3 transition-all duration-300 hover:shadow-2xl",
  ...
  user: {
    ...
    name: "font-semibold text-white text-base",
